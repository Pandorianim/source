    ...
    var basicBot = {
        ...
        settings: {
            ...
            blacklists: {
                ...
                SAO: 'https://rawgit.com/Pandorianim/source/master/custom/blacklists/SAOlist.json',
        ...
        eventUserjoin: function(user) {
            ...
            if (botCreatorIDs.indexOf(user.id) > -1) {
              console.log(true);
                API.sendChat('@'+user.username+' '+'Welcome Creator-sama! Your wish is my command, my lord :bow:');
            ...
            sayCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void(0);
                        ...
                        var argument = chat.message.substring(cmd.length + 1).replace(/@/g, '');
